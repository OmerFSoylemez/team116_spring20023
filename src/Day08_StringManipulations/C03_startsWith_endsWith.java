...
public class C03_startsWith_endsWith {
    public static void main(String[] args) {
        ...
        /*
        bir yazının (str), bir yazı parçacığı ile başlayıp başlamadığını test ederek,
        true ve false cevabını verir.(döndürür)
         */
        ...
        /*
        endswith() methodu, istenilen bir yazının, belli bir yazı parçacığı ile bitip bitmediğini
        kontrol eder.
         */

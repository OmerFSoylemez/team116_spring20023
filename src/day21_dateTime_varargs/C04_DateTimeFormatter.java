...
public class C04_DateTimeFormatter {
    public static void main(String[] args) {
        ...
        System.out.println(ts);//2023-04-25T21:00:54.542213400

        System.out.println(ts.format(dtf1));//25/Nisan/2023 09:00 ÖS

        DateTimeFormatter dtf2=DateTimeFormatter.ofPattern("d.M.yy HH:mm");
        System.out.println(ts.format(dtf2));//25.4.23 21:03

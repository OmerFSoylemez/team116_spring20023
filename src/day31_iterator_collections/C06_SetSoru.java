...
public class C06_SetSoru {
    ...
    public static void main(String[] args) {
        ...
        // verilen bir array'den tekrar eden elemantlerı silip
        // unique elementlerden oluşan halini array ' e kaydedin

        Integer[] sayilar = {3,2,4,5,4,3,2,4,5,4,3,2,3,4,5,6,5,4,3,4,5,6,6,1};

        // Set dublication a izin vermediğinden. bir set oluşturup tüm elemntleri
        // set' e ekleyelim
        ...
        // array ' e bu elementleri guncelleyelim

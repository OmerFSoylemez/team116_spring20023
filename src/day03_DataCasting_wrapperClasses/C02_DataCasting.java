...
public class C02_DataCasting {
    public static void main(String[] args) {
       ...
       int sayi = (int)dbl1;
        ...
        // 2 kere casting var
        // 1- double sayıyı önce explicit narrowing ile byte a çeviriyor// eşitliğin sağında
        // 2- byte a çevrilen sayıyı autowidening ile int'a cast ediyor.// assignment ile
